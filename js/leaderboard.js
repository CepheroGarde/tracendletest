...
async function updateDailySolverBadge() {
  ...
  try {
    ...
    if (total === 0) {
      ...
      html = `<strong>1 Total Player Answered</strong> • <span class="text-green-600 font-medium">${winRate}% Win Rate</span>`;
    } else {
      html = `<strong>${total} Total Players Answered</strong> • <span class="text-green-600 font-medium">${winRate}% Win Rate</span>`;
    }
